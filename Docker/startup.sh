#!/bin/sh
PROJECT_ROOT="/workspaces/Webapp33"   
...
echo 'source /workspaces/Webapp33/.venv/bin/activate' >> /home/vscode/.bashrc
echo 'source /workspaces/Webapp33/.venv/bin/activate' >> /home/vscode/.zshrc

echo 'export PYTHONPATH="/workspaces/Webapp33/llm_utils:${PYTHONPATH}"' >> ~/.profile
