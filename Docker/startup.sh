#!/bin/sh
PROJECT_ROOT="/workspaces/Webapp4"   
...
echo 'source /workspaces/Webapp4/.venv/bin/activate' >> /home/vscode/.bashrc
echo 'source /workspaces/Webapp4/.venv/bin/activate' >> /home/vscode/.zshrc

echo 'export PYTHONPATH="/workspaces/Webapp4/llm_utils:${PYTHONPATH}"' >> ~/.profile
