...
Webapp33Config.LOGS_DIR.mkdir(parents=True, exist_ok=True)
...
logging_config = {
    ...
    "handlers": {
        ...
        "info": {
            ...
            "filename": str(Webapp33Config.LOGS_DIR / "info.log"),
            "maxBytes": 10485760,
            "backupCount": 10,
            "formatter": "detailed",
            "level": logging.INFO,
        ...
        "error": {
            "class": "logging.handlers.RotatingFileHandler",
            "filename": str(Webapp33Config.LOGS_DIR / "error.log"),
            "maxBytes": 10485760,
            "backupCount": 10,
            "formatter": "detailed",
            "level": logging.ERROR,
