...
from Webapp33_config.config import Webapp33Config
from Webapp33.sample_handler import StreamlitBaseHandler

def main():
    """
    Main sets up the web app title, header and tabs.
    """
    st.set_page_config(page_title="Webapp33", page_icon="🏷️")
    st.title("🏷️ Webapp33 🤖")
    st.markdown(Webapp33Config.HEADER_MARKDOWN)
